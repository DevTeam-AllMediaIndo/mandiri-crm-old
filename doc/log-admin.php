...
<div class="card">
    <div class="card-header font-weight-bold">Log Admin</div>
    <div class="card-body">
            ...
            <table id="table" class="table table-striped table-hover" width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="15%" style="vertical-align: middle" class="text-center">Admin</th>
                        ...
                        <th width="15%" style="vertical-align: middle" class="text-center">IP</th>
                    </tr>
                </thead>
            </table>
        </div>
