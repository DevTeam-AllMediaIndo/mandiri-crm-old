...
if($user1["ADM_LEVEL"] == 3 || $user1["ADM_LEVEL"] == 1){
        ...
        if ($SQL_QUERY && mysqli_num_rows($SQL_QUERY) > 0) {
            ...
            if(isset($_POST['submit_pribadi'])){
                ...
                isset($_POST['ACC_F_APP_PRIBADI_NPWP'])){
                    ...
                    die("<script>alert('Success Update Data');location.href = 'home.php?page=member_realacc_edit&id=".$id."'</script>");
                }
            }
                            ...
                            if(in_array($s5_6_doc1_type, $allowed)){
                                ...
                                if(move_uploaded_file($_FILES["s5_6_doc1"]["tmp_name"], "upload/" . $s5_6_doc1_new)){
                                    ...
                                    try {
                                        ...
                                        die("<script>alert('Error Uploading');location.href = 'home.php?page=member_realacc_edit&id=".$id."'</script>");
                                    }
                                } else { die("<script>alert('Failed Upload');location.href = 'home.php?page=member_realacc_edit&id=".$id."'</script>"); }
                            } else { die("<script>alert('check type image 1');location.href = 'home.php?page=member_realacc_edit&id=".$id."'</script>"); }
                        } else { die("<script>alert('check type image 2');location.href = 'home.php?page=member_realacc_edit&id=".$id."'</script>"); }
                    } else { die("<script>alert('check file size');location.href = 'home.php?page=member_realacc_edit&id=".$id."'</script>"); }
                };
    ...
    } else { die("<script>alert('please check link again');location.href = 'home.php?page=member_realacc_edit&id=".$id."'</script>"); }
?>
<!-- ================================================================ -->
<ul id="tabs" class="nav nav-tabs nav-fill">
    <li class="nav-item"><a href="#profile_pribadi" data-target="#profile_pribadi" data-toggle="tab" class="nav-link active"><strong>Profile Pribadi</strong></a></li>
