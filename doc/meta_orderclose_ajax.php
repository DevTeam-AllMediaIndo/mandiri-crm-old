<?php
    ...
    $dt->edit('CLOSE_PRICE', function($data){
        return "<div class='text-right'>".number_format($data['CLOSE_PRICE'], $data['DIGITS'])."</div>";
    });
    $dt->edit('CLOSE_PRICE', function($data){
        return "<div class='text-right'>".number_format($data['CLOSE_PRICE'], $data['DIGITS'])."</div>";
    });
    ...
    $dt->edit('PROFIT', function($data){
        return "<div class='text-right'>".number_format($data['PROFIT'], 2)."</div>";
    });
