<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Order Open</li>
    </ol>
</nav>
<div class="card mt-3">
    <div class="card-header font-weight-bold">Order Open</div>
    <div class="card-body">
        <div class="table-responsive">
            <table id="table" class="table table-striped table-hover" width="100%">
                <thead>
                    <tr>
                        <th style="vertical-align: middle" class="text-center">Position ID</th>
                ...
                <tbody>
                    ...
                    if ($sql_get_account_real && mysqli_num_rows($sql_get_account_real) != 0) :
                        ...
                        $OpenedOrdersList  = mt5api_connect("OpenedOrdersList", $params);
                        $history = json_decode($OpenedOrdersList);
                    ?>
                        ...
                        <?php if ($history->status == "success" && is_array($history->message)) : ?>
                            <?php foreach ($history->message as $order) : ?>
                                <tr>
                                    ...
                                    <td><?= $order->symbol ?></td>
                                    <td class="text-right"><?= $order->volume ?></td>
