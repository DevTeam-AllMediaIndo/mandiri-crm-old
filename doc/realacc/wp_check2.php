                ...
                if(isset($_POST['margin'])){
                    if(isset($_POST['note'])){
                        if(isset($_POST['voucher'])){
                            ...
                            } else if($RESULT_QUERY['ACC_PRODUCT'] == 'Index Asia (Gulir)'){
    ...
    <div class="card mt-3">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-10 mt-2" style="margin-block: auto;"><input type="text" class="form-control" value="CCF/NC/M/" name="voucher" required></div>
                <div class="col-sm-2" style="margin-block: auto;">Nama</div>
                <div class="col-sm-10 mt-2"><input type="text" class="form-control text-center" readonly value="<?php echo $RESULT_QUERY['MBR_NAME']; ?>"></div>
                <div class="col-sm-2" style="margin-block: auto;">Email</div>
                <div class="col-sm-10 mt-2" style="margin-block: auto;"><input type="text" class="form-control text-center" readonly value="<?php echo $RESULT_QUERY['MBR_EMAIL']; ?>"></div>
                <div class="col-sm-2" style="margin-block: auto;">No.Telp</div>
                <div class="col-sm-10 mt-2"><input type="text" class="form-control text-center" readonly value="<?php echo $RESULT_QUERY['MBR_PHONE']; ?>"></div>
            </div>
            <hr>
            <div class="row">
                <div class="col-md-6">
            ...
            <hr>
            <div class="row">
                <div class="col-sm-2" style="margin-block: auto; visibility : <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Forex dan Gold'){ echo 'visible';}else{echo 'hidden';}?>;" id="forexdiv1">Forex</div>
                <div class="col-sm-4" id="forexinpt1" style="visibility : <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Forex dan Gold'){ echo 'visible';}else{echo 'hidden';}?>;">
                    <select class="form-control text-center" name="forex" <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Forex dan Gold'){ echo 'required';}?>>
                ...
                <div class="col-sm-2 text-left" style="margin-block: auto; visibility : <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Index Asia (Gulir)'){ echo 'visible';}else{echo 'hidden';}?>;" id="indexdiv1"><i class="fa fa-tag" aria-hidden="true" ></i>JPK50</div>
                <div class="col-sm-4" id="indexinpt" id="indexinpt1" style="visibility : <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Index Asia (Gulir)'){ echo 'visible';}else{echo 'hidden';}?>;">
                    <select class="form-control text-center" name="jpk50" <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Index Asia (Gulir)'){ echo 'required';}?>>
                        <option value="0">Pilih Nilai</option>
                        <option value="10">10</option>
                        <option value="30">30</option>
                        <option value="50">50</option>
            ...
            <div class="row mt-2">
                <div class="col-sm-2" style="margin-block: auto; visibility : <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Forex dan Gold'){ echo 'visible';}else{echo 'hidden';}?>;" id="forexdiv2">Locco London</div>
                <div class="col-sm-4" id="forexinpt2" style="visibility : <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Forex dan Gold'){ echo 'visible';}else{echo 'hidden';}?>;">
                    <select class="form-control text-center" name="loco" <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Forex dan Gold'){ echo 'required';}?>>
                        <option value="0">Pilih Nilai</option>
                        <option value="10">10</option>
                        <option value="30">30</option>
                        <option value="50">50</option>
                ...
                <div class="col-sm-2 text-left" style="margin-block: auto; visibility : <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Index Asia (Gulir)'){ echo 'visible';}else{echo 'hidden';}?>;" id="indexdiv2"><i class="fa fa-tag" aria-hidden="true" ></i>JPK30</div>
                <div class="col-sm-4" id="indexinpt2" style="visibility : <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Index Asia (Gulir)'){ echo 'visible';}else{echo 'hidden';}?>;">
                    <select class="form-control text-center" name="jpk30" <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Index Asia (Gulir)'){ echo 'required';}?>>
                        <option value="0">Pilih Nilai</option>
                        <option value="10">10</option>
                        <option value="30">30</option>
                        <option value="50">50</option>
            ...
            <div class="row mt-2">
                ...
                <div class="col-sm-2 text-left" style="margin-block: auto; visibility : <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Index Asia (Gulir)'){ echo 'visible';}else{echo 'hidden';}?>;" id="indexdiv3"><i class="fa fa-tag" aria-hidden="true" ></i>HKK50/HKJ50</div>
                <div class="col-sm-4" id="indexinpt3" style="visibility : <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Index Asia (Gulir)'){ echo 'visible';}else{echo 'hidden';}?>;">
                    <select class="form-control text-center" name="hkk50" <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Index Asia (Gulir)'){ echo 'required';}?>>
                        <option value="0">Pilih Nilai</option>
                        <option value="10">10</option>
                        <option value="30">30</option>
                        <option value="50">50</option>
            ...
            <div class="row mt-2">
                <div class="col-sm-2" style="margin-block: auto;">&nbsp;</div>
                <div class="col-sm-4">&nbsp;</div>
                <div class="col-sm-2 text-left" style="margin-block: auto; visibility : <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Index Asia (Gulir)'){ echo 'visible';}else{echo 'hidden';}?>;" id="indexdiv4"><i class="fa fa-tag" aria-hidden="true" ></i>KRJ35</div>
                <div class="col-sm-4" id="indexinpt4" style="visibility : <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Index Asia (Gulir)'){ echo 'visible';}else{echo 'hidden';}?>;">
                    <select class="form-control text-center" name="krj35" <?php if($RESULT_QUERY['ACC_PRODUCT'] == 'Index Asia (Gulir)'){ echo 'required';}?>>
                        <option value="0">Pilih Nilai</option>
                        <option value="10">10</option>
                        <option value="30">30</option>
                        <option value="50">50</option>
