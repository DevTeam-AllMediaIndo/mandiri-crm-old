    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(isset($_POST['accept_1']) && isset($_POST['id']) && isset($_POST['note'])){
            ...
            if(mysqli_num_rows($SQL_QUERY) > 0){
                ...
                // Message Telegram
                $mesg = 'Notif : Deposit Verifikasi Diterima'.
                ...
                // Message Telegram
                $mesg_othr = 'Notif : Deposit Verifikasi Diterima'.
                PHP_EOL.'Date : '.date("Y-m-d").
                PHP_EOL.'Time : '.date("H:i:s").
                PHP_EOL.'====================================='.
                PHP_EOL.'                         Informasi Deposit '.
        ...
        if(isset($_POST['reject_1']) && isset($_POST['id']) && isset($_POST['note'])){
            ...
            if(mysqli_num_rows($SQL_QUERY) > 0){
                ...
                // Message Telegram
                $mesg = 'Notif : Deposit Verifikasi Ditolak'.
                PHP_EOL.'Date : '.date("Y-m-d").
                PHP_EOL.'Time : '.date("H:i:s");
                // PHP_EOL.'======== Informasi Deposit =========='.
                // PHP_EOL.'Nama : '.$RESULT_QUERY['MBR_NAME'].
                ...
                // Message Telegram
                $mesg_othr = 'Notif : Deposit Verifikasi Ditolak'.
                PHP_EOL.'Date : '.date("Y-m-d").
                PHP_EOL.'Time : '.date("H:i:s").
                PHP_EOL.'====================================='.
                PHP_EOL.'                         Informasi Deposit '.
        ...
        if(isset($_POST['accept_2']) && isset($_POST['id']) && isset($_POST['note'])){
            ...
            if(mysqli_num_rows($SQL_QUERY) > 0){
                ...
                // Message Telegram
                $mesg = 'Notif : Deposit Finansial Diterima'.
                PHP_EOL.'Date : '.date("Y-m-d").
                PHP_EOL.'Time : '.date("H:i:s");
                // PHP_EOL.'======== Informasi Deposit =========='.
                // PHP_EOL.'Nama : '.$RESULT_QUERY['MBR_NAME'].
                ...
                // Message Telegram
                $mesg_othr = 'Notif : Deposit Finansial Diterima'.
                PHP_EOL.'Date : '.date("Y-m-d").
                PHP_EOL.'Time : '.date("H:i:s").
                PHP_EOL.'====================================='.
                PHP_EOL.'                         Informasi Deposit '.
        ...
        if(isset($_POST['reject_2']) && isset($_POST['id']) && isset($_POST['note'])){
            ...
            if(mysqli_num_rows($SQL_QUERY) > 0){
                ...
                // Message Telegram
                $mesg = 'Notif : Deposit Finansial Ditolak'.
                PHP_EOL.'Date : '.date("Y-m-d").
                PHP_EOL.'Time : '.date("H:i:s");
                // PHP_EOL.'======== Informasi Deposit =========='.
                // PHP_EOL.'Nama : '.$RESULT_QUERY['MBR_NAME'].
                ...
                // Message Telegram
                $mesg_othr = 'Notif : Deposit Finansial Ditolak'.
                PHP_EOL.'Date : '.date("Y-m-d").
                PHP_EOL.'Time : '.date("H:i:s").
                PHP_EOL.'====================================='.
                PHP_EOL.'                         Informasi Deposit '.
        ...
        if(isset($_POST['accept_3']) && isset($_POST['id']) && isset($_POST['note']) && isset($_POST['voucher'])){
            ...
            if(mysqli_num_rows($SQL_QUERY) > 0){
                ...
                // Message Telegram
                $mesg = 'Notif : Deposit Autorisasi Diterima'.
                PHP_EOL.'Date : '.date("Y-m-d").
                PHP_EOL.'Time : '.date("H:i:s");
                // PHP_EOL.'======== Informasi Deposit =========='.
                // PHP_EOL.'Nama : '.$RESULT_QUERY['MBR_NAME'].
                ...
                // Message Telegram
                $mesg_othr = 'Notif : Deposit Autorisasi Diterima'.
                PHP_EOL.'Date : '.date("Y-m-d").
                PHP_EOL.'Time : '.date("H:i:s").
                PHP_EOL.'====================================='.
                PHP_EOL.'                         Informasi Deposit '.
        ...
        if(isset($_POST['reject_3']) && isset($_POST['id']) && isset($_POST['note'])){
            ...
            if(mysqli_num_rows($SQL_QUERY) > 0){
                ...
                // Message Telegram
                $mesg = 'Notif : Deposit Autorisasi Ditolak'.
                PHP_EOL.'Date : '.date("Y-m-d").
                PHP_EOL.'Time : '.date("H:i:s");
                // PHP_EOL.'======== Informasi Deposit =========='.
                // PHP_EOL.'Nama : '.$RESULT_QUERY['MBR_NAME'].
                ...
                // Message Telegram
                $mesg_othr = 'Notif : Deposit Autorisasi Ditolak'.
                PHP_EOL.'Date : '.date("Y-m-d").
                PHP_EOL.'Time : '.date("H:i:s").
                PHP_EOL.'====================================='.
                PHP_EOL.'                         Informasi Deposit '.
            ...
            <table class="table table-striped table-hover table-bordered" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle" class="text-center"><a target='_blank' href='<?php echo 'https://'.$bucketName.'.s3.'.$region.'.amazonaws.com/'.$folder.'/'.$RESULT_QUERY['DPWD_PIC'] ?>'>Open</a></td>
