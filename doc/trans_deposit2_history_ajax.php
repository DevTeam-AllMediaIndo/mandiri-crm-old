<?php
    ...
    $dt->edit('DPWD_PIC', function($data){
        return "<div class='text-center'><a target='_blank' href='https://allmediaindo-2.s3.ap-southeast-1.amazonaws.com/ccftrader/".$data['DPWD_PIC']."'>Pic</a></div>";
    });
    $dt->edit('ID_DPWD_HASH', function($data){
        return "<div class='text-center'><a target='_blank' href='pdf/root/trans_topup.php?x=".$data['ID_DPWD_HASH']."'>Print</a></div>";
    });
