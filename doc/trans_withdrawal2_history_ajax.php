<?php
    ...
    $dt->edit('DPWD_STSVER', function($data){
        if($data['DPWD_STSVER'] == 'Accept'){
            ...
            ";
        }else if($data['DPWD_STSVER'] == 'Pending'){
            return "
                <div class='text-center'>
    ...
    $dt->edit('ID_DPWD_HASH', function($data){
        return "<div class='text-center'><a target='_blank' href='pdf/root/trans_withdrawal.php?x=".$data['ID_DPWD_HASH']."'>Print</a></div>";
    });
