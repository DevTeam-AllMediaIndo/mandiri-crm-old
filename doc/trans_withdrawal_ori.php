        ...
        if(isset($_GET['x'])){
            ...
            if(mysqli_num_rows($SQL_QUERY) > 0){
                ...
                try {
                    ...
                    //Content
                    $mail->isHTML(true);
                    $mail->Subject = 'Withdrawal Information '.$setting_site_name.' '.date('Y-m-d H:i:s');
                        ...
                        <body style='background-color:#cacaca'>
                            ...
                            <div style='max-width: 600px; background-color:#ffffff;margin: auto;border: 1px solid #eaeaea;padding: 20px;border-radius: 5px;'>
                                ...
                                <div style='padding: 10px;text-align: justify;'>
                                    <strong>Informasi Data Withdrawal</strong><br>

                                    Hi <strong>".$RESULT_QUERY['MBR_NAME'].", </strong><br>
                                    Withdrawal anda Rp. ".number_format($RESULT_QUERY['DPWD_AMOUNT'], 0)." Telah di ".$action."<br>
...
<?php if($user1["ADM_LEVEL"] == 1 || $user1["ADM_LEVEL"] == 2 || $user1["ADM_LEVEL"] == 3|| $user1["ADM_LEVEL"] == 6){ ?>
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="table_pending" class="table table-striped table-hover" width="100%">
                    <thead>
                        <tr>
                            <th style="vertical-align: middle" class="text-center" rowspan="2">Date</th>
                            <th style="vertical-align: middle" class="text-center" rowspan="2">Username</th>
                            <th style="vertical-align: middle" class="text-center" rowspan="2">Name</th>
                            <th style="vertical-align: middle" class="text-center" rowspan="2">Bank Name</th>
                            <th style="vertical-align: middle" class="text-center" rowspan="2">Bank Account</th>
                            <th style="vertical-align: middle" class="text-center" rowspan="2">Login</th>
                            <th style="vertical-align: middle" class="text-center" colspan="3">Amount</th>
                            <th style="vertical-align: middle" class="text-center" rowspan="2">Action</th>
                        </tr>
                        <tr>
                            <th style="vertical-align: middle" class="text-center">IDR</th>
                            <th style="vertical-align: middle" class="text-center">Rate</th>
                            <th style="vertical-align: middle" class="text-center">USD</th>
                        </tr>
                    </thead>
                </table>
            </div>
