...
class PDFMerger
{
	...
	{
		require_once(str_replace('0e03qkuh', 'vendor/tecnickcom/', realpath(dirname(dirname(__FILE__)))).'tcpdf/tcpdf.php');
		require_once(str_replace('0e03qkuh', 'vendor/tecnickcom/', realpath(dirname(dirname(__FILE__)))).'tcpdf/tcpdi.php');
	}
