    ...
    $content = '
        ...
        <html>
            ...
            <body>
                <table width="100%">
                    <tr>
                        <td width="25%" style="vertical-align: top; "><img src="data:image/png;base64,'.base64_encode(file_get_contents("https://".$bucketName.".s3.".$region.".amazonaws.com/".$folder."/".$setting_pdf_logo."")).'" width="100%"></td>
                ...
                <table style="margin-top:25px;" width="100%">
                    ...
                    <tr>
                        <td style="width:1%; white-space: nowrap;">The sum of '.$rudol.'</td>
                        <td width="1%">&nbsp;:&nbsp;</td>
