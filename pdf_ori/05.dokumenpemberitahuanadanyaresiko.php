...
<?php
    ...
    if(mysqli_num_rows($SQL_QUERY) > 0){
        ...
        $ACC_05_AGGDATE = $RESULT_QUERY['ACC_05_AGGDATE'];
            ...
            <body>
                ...
                <ol>
                    ...
                    <li class="text-justify mt-2">
                        ...
                        Berjangka atau subjek kontrak '.ucwords($title).', terjadi kerusakan sistem pada Bursa
                        Berjangka atau Pialang Berjangka, atau posisi Anda berada dalam pasar yang
                        tidak likuid. Bahkan apabila Anda dapat melikuidasi posisi tersebut, Anda
                ...
                <div style="text-align:center;margin-top:25px;margin-left:25%">
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top;"><div style="margin:0px 5px;">:</div></td>
                            <td><strong>'.date('Y-m-d H:i:s', strtotime($ACC_05_AGGDATE)).'</strong></td>
                        </tr>
                    </table>
                </div>
            </body>
